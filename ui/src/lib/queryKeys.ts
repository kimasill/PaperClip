export const queryKeys = {
  ...
  organizations: (companyId: string) => ["organizations", companyId] as const,
  organizationMembers: (companyId: string, orgId: string) => ["organizations", companyId, orgId, "members"] as const,
  skills: {
